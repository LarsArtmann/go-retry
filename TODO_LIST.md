...
| T47 | Observe the first green CI run carrying the `tools/` vet step (`go -C tools vet ./...`, added to the lint job 2026-09-17), then retire this row                                                                                                         | P3 | The step landed but is unpushed; the remote run is the only unverified half           | 2026-09-17 09:36 `§b.5`/`§f.4`                         |
